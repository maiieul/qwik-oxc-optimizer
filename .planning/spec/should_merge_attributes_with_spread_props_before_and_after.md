# Test: should_merge_attributes_with_spread_props_before_and_after
...
| `_getVarProps` | `test.tsx_test_component_LUXeXe0DQrg.js` | `@qwik.dev/core` | 3 |
| `_getConstProps` | `test.tsx_test_component_LUXeXe0DQrg.js` | `@qwik.dev/core` | 3 |
