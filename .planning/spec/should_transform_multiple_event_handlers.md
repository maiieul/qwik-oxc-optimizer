# Test: should_transform_multiple_event_handlers

## Test Configuration

**Note:** Multiple event handlers (onClick$, onMouseOver$) on elements inside .map() loop. Tests QRL hoisting with q:p (parent context) parameter passing.
