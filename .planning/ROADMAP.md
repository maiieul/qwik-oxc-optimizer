...
Plans:
- [ ] 08-01: Parse + semantic + collector pipeline (parse.rs, collector.rs, words.rs, hash.rs)
- [ ] 08-02: QwikTransform traverse with $() detection and QRL wrapping (transform.rs, import_rewrite.rs, entry_strategy.rs)
